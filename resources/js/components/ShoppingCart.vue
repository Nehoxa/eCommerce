                        ...
                        <template v-for="product in products" v-bind:key="product.id">
                            <tr>
                                ...
                                <td class="hidden text-right md:table-cell">
                                    <span class="text-sm lg:text-base font-medium" v-text="product.price"></span>
                                </td>
                                <td class="text-right">
                                    <span class="text-sm lg:text-base font-medium" v-text="product.price * product.quantity
                                        "></span>
                                </td>
                            </tr>
                        </template>
                        ...
                        <div class="p-4">
                            ...
                            <a href="/checkout">
                                <button
                                    ...
                                    <span class="ml-2 mt-5px">Passer la commande</span>
                                </button>
                            </a>
                        </div>
                    </div>
